<template>
  <div>
    ...
    <div
      class="swiperBgClass"
      :class="{ areaActive: currentIndex == 'swiperBgIndustry' }"
      @click="editData('swiperBgIndustry', $event)"
    >
      <swiper-bg-industry></swiper-bg-industry>
    </div>
    <div class="content_exhibit">
      <div
        class="main_padding"
        style="padding: 0 !important"
        :class="{ areaActive: currentIndex == 'industry' }"
        @click="editData('industry', $event)"
      >
