<template>
  <div>
    ...
    <div
      class="swiperBgClass"
      :class="{ areaActive: currentIndex == 'swiperBgBranch' }"
      @click="editData('swiperBgBranch', $event)"
    >
      <swiper-bg-branch></swiper-bg-branch>
    </div>
    ...
    <div class="content_exhibit">
      <div
        ...
        :class="{ areaActive: currentIndex == 'branchMap' }"
        @click="editData('branchMap', $event)"
      >
    ...
    <div class="content_exhibit">
      <div
        class="main_padding"
        style="padding: 5.8rem 22rem 6.2rem"
        :class="{ areaActive: currentIndex == 'companyShowArr' }"
        @click="editData('companyShowArr', $event)"
      >
        <div class="area_content">
