...
<div>
  <swiper-bg-honor></swiper-bg-honor>
</div>

<div class="content_exhibit">
  <div class="main_padding" style="padding:0">
  <div class="area_content">
    <honor-recommend></honor-recommend>
  </div>
  </div>
</div>

<div class="content_exhibit">
  <div class="main_padding" style="padding: 5.8rem 10rem 6.2rem">
  <div class="area_content">
    <honor-prise></honor-prise>
  </div>
  </div>
</div>
